...
<!-- REPO-TRACKER:START -->
<!-- Auto-updated: Sat, 13 Jun 2026 08:53:13 GMT -->
...
|------|-------------|-------|----------|
| [**antigravity-awesome-skills**](https://github.com/tbalt88/antigravity-awesome-skills) | Installable GitHub library of 1,500+ agentic skills for Claude Co… | ⭐ 40,560 ↑ | Python |
| [**wifi-densepose**](https://github.com/tbalt88/wifi-densepose) | π RuView turns commodity WiFi signals into real-time spatial inte… | ⭐ 73,533 ↑ | Rust |
| [**llama_index**](https://github.com/tbalt88/llama_index) | LlamaIndex is the leading document agent and OCR platform | ⭐ 50,101 ↑ | Python |
| [**claude-mem**](https://github.com/tbalt88/claude-mem) | Persistent Context Across Sessions for Every Agent –  Captures ev… | ⭐ 82,053 ↑ | JavaScript |
| [**crewAI**](https://github.com/tbalt88/crewAI) | Framework for orchestrating role-playing, autonomous AI agents. B… | ⭐ 53,403 ↑ | Python |
| [**promptfx**](https://github.com/tbalt88/promptfx) | Kotlin LLM Prompts and User Interface | ⭐ 36 ↑ | Kotlin |
...
`Python` ×37  `TypeScript` ×29  `JavaScript` ×12  `C#` ×6  `Shell` ×6
...
|------|-----------|-------|
| [wifi-densepose](https://github.com/tbalt88/wifi-densepose) | Sat Jun 13 2026 | ⭐ 0 |
| [all-agentic-architectures](https://github.com/tbalt88/all-agentic-architectures) | Fri Jun 12 2026 | ⭐ 0 |
| [open-webui](https://github.com/tbalt88/open-webui) | Fri Jun 12 2026 | ⭐ 0 |
| [crmtwenty](https://github.com/tbalt88/crmtwenty) | Fri Jun 12 2026 | ⭐ 0 |
